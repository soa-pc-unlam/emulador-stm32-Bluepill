...
libs_softmmu=-lutil  -luuid  -lfdt -L/usr/lib/x86_64-linux-gnu -lpixman-1 
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.1.3
PKGVERSION=
SRC_PATH=/emulador-stm32-Bluepill/docker/qemu/qemu_stm32
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/emulador-stm32-Bluepill/docker/qemu/qemu_stm32/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
