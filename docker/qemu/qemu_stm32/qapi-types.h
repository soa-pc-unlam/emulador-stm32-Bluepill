...
typedef enum BlockdevDriver
{
    ...
    BLOCKDEV_DRIVER_HOST_DEVICE = 1,
    BLOCKDEV_DRIVER_HOST_CDROM = 2,
    BLOCKDEV_DRIVER_HOST_FLOPPY = 3,
    BLOCKDEV_DRIVER_HTTP = 4,
    BLOCKDEV_DRIVER_HTTPS = 5,
    BLOCKDEV_DRIVER_FTP = 6,
    BLOCKDEV_DRIVER_FTPS = 7,
    BLOCKDEV_DRIVER_TFTP = 8,
    BLOCKDEV_DRIVER_VVFAT = 9,
    BLOCKDEV_DRIVER_BLKDEBUG = 10,
    BLOCKDEV_DRIVER_BLKVERIFY = 11,
    BLOCKDEV_DRIVER_BOCHS = 12,
    BLOCKDEV_DRIVER_CLOOP = 13,
    BLOCKDEV_DRIVER_COW = 14,
    BLOCKDEV_DRIVER_DMG = 15,
    BLOCKDEV_DRIVER_PARALLELS = 16,
    BLOCKDEV_DRIVER_QCOW = 17,
    BLOCKDEV_DRIVER_QCOW2 = 18,
    BLOCKDEV_DRIVER_QED = 19,
    BLOCKDEV_DRIVER_RAW = 20,
    BLOCKDEV_DRIVER_VDI = 21,
    BLOCKDEV_DRIVER_VHDX = 22,
    BLOCKDEV_DRIVER_VMDK = 23,
    BLOCKDEV_DRIVER_VPC = 24,
    BLOCKDEV_DRIVER_QUORUM = 25,
    BLOCKDEV_DRIVER_MAX = 26,
} BlockdevDriver;
