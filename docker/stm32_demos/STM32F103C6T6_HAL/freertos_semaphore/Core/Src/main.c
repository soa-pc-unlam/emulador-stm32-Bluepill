...
int main(void)
{
  ...
  xTaskCreate(give_task, ( signed portCHAR * ) "V", 256/* stack size */, NULL, tskIDLE_PRIORITY + 10, NULL );
  xTaskCreate(take_task, ( signed portCHAR * ) "P", 256/* stack size */, NULL, tskIDLE_PRIORITY + 10, NULL );
